...
export default class extends React.Component {
        ...
        <div className="result-item-container">
          <div
            className={`result-item ${
              result.birth_years.length > 1 ? "multiple" : ""
            }`}
          >
  ...
  decideToIncrement(distanceFromBottom) {
    ...
    if (
      this.props.results.length > this.state.limit &&
    ...
    return (
      <div className="Results">
        <div className="prose">
          There are{" "}
          <span className="stat">
            {numeral(this.props.results.length).format("0,0")}
          </span>{" "}
        ...
        <div ref={this.resultsRef} className="results-container"></div>
