...
export default class extends React.Component {
  ...
  render() {
    ...
    Object.keys(this.state.summaryData.subjects).forEach((s) => {
      if (
        ["Men", "Women"].indexOf(this.state.summaryData.subjects[s].label) >= 0
      ) {
      ...
      <div className="MetaDash">
        ...
        <section className="module-area">
          ...
          <div className="text-menu">
            <div className="item" onClick={this.clearFilters}>
              Clear filters
            </div>
          ...
          <BirthAndRecordingYear
            ...
            subsetMode={
              this.fullData.resources.length > this.state.resources.length
            }
            data={Object.keys(this.state.summaryData.birthYears)
            ...
            filterItems={(t) => {
              ...
              let retArr = results
                ...
                .map((i) => {
                  const retItem = {
                    ...i,
                    count: this.state.summaryData.interviewers[i.id].count,
                  };
