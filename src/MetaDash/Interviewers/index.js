...
export default class extends React.Component {
  ...
  handleItemClick(item) {
    ...
    if (item.id in selections) {
      console.log("item.id in selections", item.id in selections);
      this.updateSelections(selectionsWithoutCurrentItem);
    } else {
      console.log("nah");
      this.updateSelections(selectionsWithoutCurrentItem.concat([item]));
    }
